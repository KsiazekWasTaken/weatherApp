 ...
 */
public class WindSpeedControl extends WeatherValueControl  {


        protected StringProperty prefixProperty = new SimpleStringProperty("Wind speed: ");
        protected StringProperty suffixProperty = new SimpleStringProperty("m/s");
